...
if st.session_state.language is None:
    ...
    with col2:
        languages = {"English": "English", "हिन्दी": "हिन्दी", "ଓଡ଼ିଆ": "ଓଡ଼ିଆ"}
        selected_language = st.selectbox("", list(languages.keys()), key="language_select", format_func=lambda x: languages[x])

        if st.button("✅ Confirm / पुष्टि करें / ନିଶ୍ଚିତ କରନ୍ତୁ", key="confirm_button", use_container_width=True):
